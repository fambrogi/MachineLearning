""" Main script to run the classification tasks
    ML SS2021 - Exercise 1
    authors:: Federico Ambrogi, e1449911@student.tuwien.ac.at
...
def printMatrix(target, matrix, classifier, param, dataset, balance = '', validation = ''):
    """ Creates the plot of a confusion matrix """
    fs = 12
...
def balance_ds(ds, dataset):
	...
	Will not work for drugs dataset """
